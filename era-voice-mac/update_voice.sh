...
uv pip install edge-tts --python "/Users/akshaybhagat/Documents/ERA'S ARENA/.venv"

# Restart the daemon
kill $(cat ~/.gemini/antigravity/era_voice/voice_daemon.pid) 2>/dev/null
pkill -f voice_daemon.py 2>/dev/null
nohup "/Users/akshaybhagat/Documents/ERA'S ARENA/.venv/bin/python" ~/.gemini/antigravity/era_voice/voice_daemon.py > /tmp/era_voice.log 2>&1 &
